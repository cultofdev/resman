    ...
    <div class="body">
        ...
        <div class="detail-container">
            ...
            <div class="prize-detail">
                ...
                <hr>
                <button type="button" v-on:click="openConfirmModal()">Redeem<i class="pi pi-angle-right"></i></button>
                <hr>
...
export default {
    ...
    methods: {
        ...
        async updatePrizeQuantity() {
            ...
            try {
                await PrizeService.put('http://localhost:5000/api/prize/one', params);
            } catch(error) {
                console.error(error);
            }
