...
export default {
    ...
    async mounted() {
        ...
        try {
            await PrizeService.put('http://localhost:5000/api/prize/one', params).then(res => (this.prize = res.data));
    ...
    methods: {
        ...
        async updatePrizeQuantity() {
            ...
            try {
                await PrizeService.get('http://localhost:5000/api/prize/one', params).then(res => console.log(res));
            } catch(error) {
                console.error(error);
            }
