<template>
    <div class="container">
        ...
        <div class="prize-detail">
            <h1 style="text-align: left; margin-left: 30px">Win a {{prize.name}}</h1>
            <hr style="width: 85%; background-color: lightgray">
            <button type="button">Redeem</button>
            <hr>
            <p style="text-align: left; margin-left: 30px">{{prize.quantity}} left in stock</p>
        </div>
    </div>
