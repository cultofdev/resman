<template>
    <div class="detail-container">
        ...
        <div class="prize-detail">
            ...
            <hr>
            <button :disabled="prize.quantity < 1" type="button" @click="openConfirmModal">Redeem<i class="pi pi-angle-right"></i></button>
            <hr>
...
export default {
    ...
    async mounted() {
        this.retrieveRewardDetails();
    },
    methods: {
        async retrieveRewardDetails() {
            const params = new URLSearchParams();
            params.append('id', this.$route.query.id)

            try {
                await PrizeService.get('https://resman-tech-challenge.herokuapp.com/api/prize/one', params).then(res => (this.prize = res.data));
        ...
        async updatePrizeQuantity() {
            ...
            try {
                await PrizeService.put('https://resman-tech-challenge.herokuapp.com/api/prize/one', params).then(res => {
                    if(res.status === 200) {
